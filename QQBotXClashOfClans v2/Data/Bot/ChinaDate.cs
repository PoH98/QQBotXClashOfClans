...
namespace QQBotXClashOfClans_v2
{
    public static class ChinaDate
    {
        ...
        private static readonly Dictionary<string, GHoliday> gHoliday = new Dictionary<string, GHoliday>();
        private static readonly Dictionary<string, NHoliday> nHoliday = new Dictionary<string, NHoliday>();
